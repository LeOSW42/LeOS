...
*/
imagettftext($image, 24, -10,  10, 35, random($colors), ABSPATH .'/'. random($fonts), $char1);
imagettftext($image, 24,  20,  42, 35, random($colors), ABSPATH .'/'. random($fonts), $char2);
imagettftext($image, 24, -35,  60, 35, random($colors), ABSPATH .'/'. random($fonts), $char3);
imagettftext($image, 24,  25, 95, 35, random($colors), ABSPATH .'/'. random($fonts), $char4);
imagettftext($image, 24, -15, 110, 35, random($colors), ABSPATH .'/'. random($fonts), $char5);
